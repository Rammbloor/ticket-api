...
export class RenameMigration1740227451861 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "order_number" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD CONSTRAINT "UQ_59e7d78f044f0b28b239ab17bad" UNIQUE ("order_number")`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "departure_date" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "arrival_date" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "booking_date" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "passenger" ADD "last_name" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "passenger" ADD "first_name" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "passenger" ADD "middle_name" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "passenger" DROP COLUMN "middle_name"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" DROP COLUMN "departure_date"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "document" ADD "documentType" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "passenger" ADD "middleName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "passenger" ADD "firstName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "passenger" ADD "lastName" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "bookingDate" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "arrivalDate" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "departureDate" TIMESTAMP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD "orderNumber" character varying NOT NULL`,
    );
    await queryRunner.query(
